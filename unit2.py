...
<script src="/3227/5710add.js"></script>
...
<div id="news">
<div id="xkcdNews">
We're pleased to announce a major update to xkcd, with new reading modes to enhance user experience. Select a mode via the menu below the comic.<br /><br />
Brought to you by our excellent design team: <a href="https://github.com/ayust">Amber</a>, <a href="https://github.com/benley">Benjamin Staffin</a>, and <a href="https://github.com/cotrone">Kevin</a>.
</div>
...
"""
def findLast(corpse , target):
    lastPos = -1
    while True:
        pos = corpse.find(target , lastPos+1)
        if pos == -1:
            return lastPos
        lastPos = pos

print (findLast("monkey love monkey love love monkeys" , "key"))
"""
